...
function purpletask.new(style)
	...
	function widg:draw(_, cr, width)
		...
		cr:set_source(
			color(
				data.state.active and style.color.main or data.state.minimized and style.color.gray or style.color.icon
			)
		)
		...
		cr:set_source(
			color(
				data.state.focus and style.color.main or data.state.minimized and style.color.gray or style.color.icon
			)
		)
		...
		for i = 1, n do
			cr:set_source(
				color(
					data.state.list[i].focus and style.color.main
						or data.state.list[i].urgent and style.color.urgent
						or data.state.list[i].minimized and style.color.gray
						or style.color.icon
				)
			)
