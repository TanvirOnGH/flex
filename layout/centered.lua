-- Based on: <https://github.com/BlingCorp/bling/blob/master/layout/centered.lua>
...
function mylayout.arrange(p)
	...
	if
		nslaves < 2
		and t.master_fill_policy ~= "master_width_factor"
		and t.centered_layout_master_fill_policy ~= "master_width_factor"
	then
