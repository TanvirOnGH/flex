-- Based on: <https://github.com/BlingCorp/bling/blob/master/layout/mstab.lua>
...
local bar_style = beautiful.mstab_tabbar_style or beautiful.tabbar_style or "modern"
local bar = require("flex.widget.tabbar." .. bar_style)
